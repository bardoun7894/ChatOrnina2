  ...
  return (
    <aside className={cn(
      ...
      <div className="flex-shrink-0 mt-auto pt-3 border-t border-white/20">
        {/* Settings Container - Toggles above user profile */}
        <AnimatePresence>
          {showSettings && (
            <motion.div
              ...
              className={cn(
                "mb-3 p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20",
                "overflow-hidden"
              )}
            >
              <div className="space-y-2">
                <button
                  ...
                  className={cn(
                    ...
                    "bg-white/20 hover:bg-white/30 text-gray-700 hover:shadow-sm"
                  )}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                  </svg>
                  <span>{language === 'en' ? 'Arabic Language' : 'اللغة الانجيلزية'}</span>
                </button>
                ...
                <button className={cn(
                  ...
                  <span>{language === 'en' ? 'Advanced' : 'متقدم'}</span>
                </button>
