...
const CodeBlock: React.FC<CodeBlockProps> = ({ code }) => {
  ...
  return (
    <div className="bg-[#2D2D2D]/60 galileo-glass rounded-xl overflow-hidden max-w-2xl w-full">
      <div className="flex justify-between items-center px-4 py-2 bg-gray-700/40 galileo-glass-subtle">
